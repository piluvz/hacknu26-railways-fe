...
const DATA_POINTS = [23.8, 24.2, 24.0, 24.6, 24.1, 23.7, 23.9, 24.0, 23.6, 24.1, 24.3, 24.0, 23.8, 24.1, 24.3, 24.5];

function statusStyle(status: string): { color: string; bg: string } {
    if (status === 'Критично') return { color: '#E23F3F', bg: 'rgba(226,63,63,0.12)' };
    if (status === 'Внимание') return { color: '#EABD52', bg: 'rgba(234,189,82,0.12)' };
        ...
        <div className="flex flex-col px-5 pt-4 bg-[#171719] text-white border border-[#222223] rounded-xl overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                    <span className="text-sm text-[#696969] uppercase tracking-[0.08em]">Напряжение</span>
            ...
            <div className="flex items-baseline gap-2 mb-2">
                ...
                <span className="text-sm text-[#696969] ml-1">норма {VOLTAGE_DATA.max} {VOLTAGE_DATA.unit}</span>
            </div>
